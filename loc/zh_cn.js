module.exports = {
  ...
  settings: {
    ...
    language: '语言',
    user_avatar: '用户头像',
    tap_to_modify_avatar: '点击设置我的头像',
    user_avatar_pick: '更换头像',
    user_avatar_remove: '移除头像',
    user_avatar_remove_confirm: '确定要移除当前头像吗？',
    user_avatar_remove_success: '头像已移除',
    user_avatar_save_success: '头像已更新',
    user_avatar_settings: '用户头像',
