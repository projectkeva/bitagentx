module.exports = {
  ...
  settings: {
    ...
    language: '語言',
    user_avatar: '使用者頭像',
    tap_to_modify_avatar: '點擊設定我的頭像',
    user_avatar_pick: '更換頭像',
    user_avatar_remove: '移除頭像',
    user_avatar_remove_confirm: '確定要移除目前頭像嗎？',
    user_avatar_remove_success: '頭像已移除',
    user_avatar_save_success: '頭像已更新',
    user_avatar_settings: '使用者頭像',
